...
public class AbstractFrameTest extends AssertJSwingTestCaseTemplate {
    ...
    public static final void setUpOnce() {
        ClientsDatForRightJPanel createClientsDataForRight = new ClientsDatForRightJPanel();
        createClientsDataForRight.createClientsDataForRight();
        ClientsDataForCenterJPanel clientsDataForCenterJPanel = new ClientsDataForCenterJPanel();
        clientsDataForCenterJPanel.createClientsDataForLow();
        LeftJPanelJackSonReadFile leftJPanelJackSonReadFile = new LeftJPanelJackSonReadFile();
        leftJPanelJackSonReadFile.createClientsDataForLeft();
    ...
    public final void setUp() {
        ...
        CreateBothTables createBothTables = GuiActionRunner.execute(new GuiQuery<CreateBothTables>() {

            @Override
            protected CreateBothTables executeInEDT() throws Exception {
                return new CreateBothTables();
            }
        });
